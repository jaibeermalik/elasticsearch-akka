...
public class ElasticSearchTutPart2Test extends AbstractSearchJUnit4SpringContextTests
{
    ...
    public void findSimilarProducts()
    {
        ...
        assertTrue(product.categoryNameExists(SampleDataGeneratorService.MACBOOK_AIR));
...
//            System.out.println(product);
            ...
            {
                assertTrue(product.categoryNameExists(SampleDataGeneratorService.MACBOOK_PRO));
            }
        }
    }
