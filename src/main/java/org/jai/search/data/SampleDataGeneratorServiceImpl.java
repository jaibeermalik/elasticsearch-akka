...
public class SampleDataGeneratorServiceImpl implements SampleDataGeneratorService
{
    ...
    private static ProductProperty findProductProperty(Set<ProductProperty> productProperties, String size, String color)
    {
    ...
    @Override
    public Product generateProductSampleDataFor(Long productId) 
    {
    ...
    private static Category findCategory(Set<Category> categories, String catName)
    {
