...
public enum SearchFacetName
{
    ...
    private SearchFacetName(final String code)
    {
        this.code = code;
    }

    public static final List<SearchFacetName> categoryFacets = Collections.unmodifiableList(Arrays.asList(SEARCH_FACET_TYPE_PRODUCT_TYPE,
            SEARCH_FACET_TYPE_AGE, SEARCH_FACET_TYPE_BRAND, SEARCH_FACET_TYPE_COLOR));
    ...
    public String getFacetFieldNameAtLevel(final int level)
    {
    ...
    public String getFacetSequencedFieldNameAtLevel(final int level)
    {
        // Level is applicable to content category facets only.
        if (categoryFacetValues().contains(this))
        {
    ...
    public String getAutoSuggestionFieldNameAtLevel(final int level)
    {
        return getCode() + HIERARCHICAL_DATA_LEVEL_STRING + level + ".suggest";
    }

    public static String getFacetSequencedFieldNameByCode(final String facetCode)
    {
    ...
    static
    {
        for (final SearchFacetName facetName : SearchFacetName.categoryFacetValues())
        {
